...
let $ac80e4835ee69e17$var$booksPerPage = 4;
...
function $ac80e4835ee69e17$var$removeBookFromFavorite(e) {
    ...
    console.log(id);
    const updatedBooks = $ac80e4835ee69e17$var$shoppingListArray.filter((b)=>b.id !== id);
...
(async ()=>{
    ...
    if ($ac80e4835ee69e17$var$selectedBooks.length === 0) document.querySelector(".tui-pagination").style.display = "none";
    else document.querySelector(".tui-pagination").style.display = "block";
    const container = document.getElementById("pagination");
    $ac80e4835ee69e17$var$paginator = new $41b54132168ac5e1$exports(container, options);
...
//# sourceMappingURL=shopping-list.acad769f.js.map
