...
var $coELb = parcelRequire("coELb");
const $c0cecc0ef3c23d0b$var$bookApi = new (0, $1SyV6.BookAPI)();
var $9c6a5ae18ead0c2e$exports = {};
/*!
 * TOAST UI Pagination
 * @version 3.4.1
 ...
 */ (function webpackUniversalModuleDefinition(root, factory) {
    $9c6a5ae18ead0c2e$exports = factory();
})(window, function() {
...
let $c0cecc0ef3c23d0b$var$booksPerPage = 4;
...
$c0cecc0ef3c23d0b$var$shoppingList.innerHTML = (0, $coELb.createSkeletonShopList)();
...
function $c0cecc0ef3c23d0b$var$removeBookFromFavorite(e) {
    ...
    console.log(id);
    const updatedBooks = $c0cecc0ef3c23d0b$var$shoppingListArray.filter((b)=>b.id !== id);
    ...
    $c0cecc0ef3c23d0b$var$updateBooksOnPage($c0cecc0ef3c23d0b$var$paginator.getCurrentPage());
}
(async ()=>{
    ...
    const container = document.getElementById("pagination");
    $c0cecc0ef3c23d0b$var$paginator = new $9c6a5ae18ead0c2e$exports(container, options);
    $c0cecc0ef3c23d0b$var$paginator.getCurrentPage();
    $c0cecc0ef3c23d0b$var$updateBooksOnPage($c0cecc0ef3c23d0b$var$paginator.getCurrentPage());
    $c0cecc0ef3c23d0b$var$paginator.on("afterMove", ({ page: page  })=>$c0cecc0ef3c23d0b$var$updateBooksOnPage(page));
    $c0cecc0ef3c23d0b$var$renderFavorites();
})();
function $c0cecc0ef3c23d0b$var$updateBooksOnPage(page) {
    const startIndex = (page - 1) * $c0cecc0ef3c23d0b$var$booksPerPage;
    $c0cecc0ef3c23d0b$var$booksOnPage = [];
    for(let index = startIndex; index < startIndex + $c0cecc0ef3c23d0b$var$booksPerPage; index++)$c0cecc0ef3c23d0b$var$booksOnPage.push($c0cecc0ef3c23d0b$var$selectedBooks[index]);
    $c0cecc0ef3c23d0b$var$booksOnPage = $c0cecc0ef3c23d0b$var$booksOnPage.filter((b)=>b);
    $c0cecc0ef3c23d0b$var$renderFavorites();
}
...
//# sourceMappingURL=shopping-list.439474d5.js.map
